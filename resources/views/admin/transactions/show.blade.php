                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        @if ($subscribeTransaction->is_paid)
                            <span class="w-fit px-3 py-2 text-sm font-bold text-black bg-green-500 rounded-full">
                                ACTIVE
                            </span>
                        @else
                            <span class="w-fit px-3 py-2 text-sm font-bold text-black bg-orange-500 rounded-full">
                                PENDING
                            </span>
                        @endif
                        <div>
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Subscribtion Start At</p>
