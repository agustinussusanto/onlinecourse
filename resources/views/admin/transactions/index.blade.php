                    ...
                    <div class="flex flex-row justify-between items-center item-card">
                        ...
                        <div>
                            ...
                            @if ($transaction->is_paid)
                                <span class="px-3 py-2 text-sm font-bold text-black bg-green-500 rounded-full">
                                        ACTIVE
                                    </span>
                                @else
                                    <span class="px-3 py-2 text-sm font-bold text-black bg-orange-500 rounded-full">
                                        PENDING
                                    </span>
                                @endif
                        </div>
