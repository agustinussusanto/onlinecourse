    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.course_videos.update', $courseVideo->id) }}"
                    class="flex flex-col gap-y-5" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video"
                            :value="old('path_video', $courseVideo->path_video)" required autofocus autocomplete="path_video" />
