    ...
    <div class="py-12">
        <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
            <div class="flex overflow-hidden flex-col gap-y-5 p-10 bg-white shadow-sm sm:rounded-lg">
                <div class="flex flex-row gap-y-10 justify-between items-center item-card">
                    ...
                    <div class="flex flex-col">
                        ...
                        <h3 class="text-xl font-bold text-indigo-950">{{ optional($course->students)->count() ?? 0 }}</h3>
                    </div>
                    <div class="flex flex-row gap-x-3 items-center">
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-col">
                        ...
                        <p class="text-sm text-slate-500">
                            {{ $course->course_videos ? $course->course_videos->count() : 0 }}
                        </p>
                    </div>
                ...
                @forelse($course->course_videos ?? [] as $video)
                    <div class="flex flex-row gap-y-10 justify-between items-center item-card">
                        ...
                        <div class="flex flex-row gap-x-3 items-center">
                            <a href="{{ route('admin.course_videos.edit', $video->id) }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                                Edit Video
                            </a>
                ...
                @empty
                    <p class="text-sm text-slate-500">No videos available.</p>
                @endforelse
            </div>
        </div>
    </div>
