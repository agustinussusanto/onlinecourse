            ...
            <div class="overflow-hidden p-10 bg-white shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 pl-3 w-full rounded-lg border border-slate-300">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @for ($i = 0; $i < 4; $i++)
                                <input type="text" class="py-3 rounded-lg border border-slate-300" placeholder="Write your copywriting" name="course_keypoints[]">
                            @endfor
                        </div>
